   ...
   shouldComponentUpdate({ updateProps, includeUpdates = true }) {
    ...
    if (includeUpdates && this._mountSpan && updateProps !== this.props.updateProps) {
      ...
      if (changedProps.length > 0) {
        const now = utils.timestampWithMs();
...
function withProfiler(
  ...
  const Wrapped = (props) => (
    React__namespace.createElement(Profiler, { ...options, name: componentDisplayName, updateProps: props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 143}}
      , React__namespace.createElement(WrappedComponent, { ...props, __self: this, __source: {fileName: _jsxFileName, lineNumber: 144}} )
    )
  );
