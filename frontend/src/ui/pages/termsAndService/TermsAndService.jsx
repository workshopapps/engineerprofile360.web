...
function TermsAndService() {
        ...
        <div className='col-sm-12 col-md-8'>
          ...
          <div className='first'>
            <p>
              ...
              companies that want to know how good their engineers are. 
              It is a software where engineers register and get various 
              multi-choice questions on different topics. The tool builds 
              a profile of each engineer in the form of a spider-web chart 
              so the company knows where its engineers need to improve.
    To provide our Services (as defined below) through our software, or 
    website, we need to obtain your agreement to our Terms of Service.
    These Terms of Service govern your use of our software.
    As used in these Terms of Service;
    "Skript service",
    "our service"
    "the service", means the personalized service provided by Skript for 
    discovering and assessing Skript content, including all features and functionalities, recommendations and reviews, our websites, and user interfaces, as well as all content and software associated with our service.
    Skript Evaluator (Skript, ``our``, ``we,`` or ``us ``) provides the services described below to you ("Services") unless you live in a country or territory where it is not eligible.
    Registration and Account.
    Your Company/team must create a Business account by providing accurate, current, and complete infor
  ...
  Unless you cancel your membership before your billing date, you authorize us to charge the membership fee for the next billing cycle to your Payment Method (see "Cancellation" below).
  2. We may offer several subscription plans, including subscriptions offered by third parties in conjunction with the provision of their products and services.
  We are not responsible for the products and services provided by such third parties. Some subscription plans may have differing conditions and limitations, which will be disclosed at your sign-up or in other communications made available to you. You can find specific details regarding your Skript subscription by visiting the Skript.com website and clicking on the "Account" link available at the top of the pages under your profile name.
  ...
  2. Payment Methods.
  To use the Skript service you must provide one or more Payment Methods. You authorize us to charge any Payment Method associated with your account in case your primary Payment Method is declined or no longer available to us for payment of your subscription fee. You remain responsible for any uncollected amounts. If payment is not successfully settled, due to expiration, insufficient funds, or otherwise, and you do not cancel your account, we may suspend your access to the service until we have successfully charged a valid Payment Method. For some Payment Methods, the issuer may charge you certain fees, such as foreign transaction fees or other fees relating to the processing of your Payment Method. Local tax charges may vary depending on the Payment Method used. Check with your Payment Method service provider for details.
  ...
  4. Cancellation.
  You can cancel your Skript subscription at any time, and you will continue to have access to the Skript service through the end of your billing period. To the extent permitted by the applicable law, payments are non-refundable and we do not provide refunds or credits for any partial membership periods or unused Skript content.
  To cancel, go to the "Account" page and follow the instructions for cancellation. If you cancel your membership, your account will automatically close at the end of your current billing period. To see when your account will close, click "Billing details" on the "Account" page. If you signed up for Skript using your account with a third party as a Payment Method and wish to cancel your Skript subscription, you may need to do so through such a third party, for example by visiting your account with the applicable third party and turning off auto-renew, or unsubscribing from the Skript service through that third party.
  4.5. Changes to the Price and Subscription Plans. We may change our subscription plans and the price of our service from time to time; however, any price changes or changes to your subscription plans will apply no earlier than 30 days following notice to you.
  ...
  No part of the content on our software must be used for commercial purposes without obtaining a license from the owners.
  If any content is printed, copied, downloaded, shared or reposted in breach of the terms of use, a user's right to access the site will be ceased immediately and at our option return or destroy copies of the materials.
            </p>
          </div>
  ...
  Skript does not accept unsolicited materials or ideas for Skript content, and it is not responsible for the similarity of any of its content or programming in any media to materials or ideas transmitted to Skript.
  12.3. Customer Support.
  To find more information about our service and its features or if you need assistance with your account, please visit the Skript Help Center, which is accessible through the Skript.com website. In certain instances, Customer Service may best be able to assist you by using a remote access support tool through which we have full access to your computer. If you do not want us to have this access, you should not consent to support through the remote access tool, and we will assist you through other means. In the event of any conflict between these Terms of Use and information provided by Customer Support or other portions of our websites, these Terms of Use will be controlled.
  12.4. Changes to Terms of Use and Assignment.
  Skript may, from time to time, change these Terms of Use. We will notify you at least 30 days before such changes apply to you. We may assign or transfer our agreement with you including our associated rights and obligations at any time and you agree to cooperate with us in connection with such an assignment or transfer.
  12.5. Electronic Communications. We will send you information relating to your account (e.g. payment authorizations, invoices, changes in password or Payment Method, confirmation messages, notices) in electronic form only, for example via emails to your email address provided during registration.
            </p>
          </div>
        </div>
        ...
        <div className="col-sm-12 col-md-8">
          ...
          <div className="second">
            ...
            <p>
              ...
              cycle to your Payment Method (see "Cancellation" below). 2. We may
              offer several subscription plans, including subscriptions offered
              by third parties in conjunction with the provision of their
              products and services. We are not responsible for the products and
              services provided by such third parties. Some subscription plans
              ...
              Skript subscription by visiting the Skript.com website and
          ...
          <div className="second">
            <h2 id="BillingandCancellation">Billing and Cancellation</h2>
            <p>
              1. Billing Cycle. The Subscription fee for the Skript service and
              ...
              the Skript.com website and click on the "Billing details" link on
              ...
              soon as you register. If you signed up for Enineering360 using
              your account with a third party as a Payment Method, you can find
              the billing information about your Skript subscription by visiting
              your account with the applicable third party. 2. Payment Methods.
              ...
              your Payment Method service provider for details. 3. Updating your
              Payment Methods. You can update your Payment Methods by going to
              the "Account" page. We may also update your Payment Methods using
              the information provided by the payment service providers.
              Following any update, you authorize us to continue to charge the
              applicable Payment Method(s). 4. Cancellation. You can cancel your
              Skript subscription at any time, and you will continue to have
              access to the Skript service through the end of your billing
              period. To the extent permitted by the applicable law, payments
              are non-refundable and we do not provide refunds or credits for
              any partial membership periods or unused Skript content. To
              cancel, go to the "Account" page and follow the instructions for
              cancellation. If you cancel your membership, your account will
              automatically close at the end of your current billing period. To
              see when your account will close, click "Billing details" on the
              "Account" page. If you signed up for Skript using your account
              with a third party as a Payment Method and wish to cancel your
              Skript subscription, you may need to do so through such a third
              party, for example by visiting your account with the applicable
              third party and turning off auto-renew, or unsubscribing from the
              Skript service through that third party. 4.5. Changes to the Price
              and Subscription Plans. We may change our subscription plans and
              the price of our service from time to time; however, any price
              changes or changes to your subscription plans will apply no
          ...
          <div className="second">
            <h2 id="WarrantiesandLimitationsonLiability">
          ...
          <div className="second">
            <h2 id="UseofYourpersonal/CompanyInformation">
          ...
          <div className="second">
            ...
            <p>
              ...
              and construed by the laws of Nigeria. 12.2. Unsolicited Materials.
              Skript does not accept unsolicited materials or ideas for Skript
              content, and it is not responsible for the similarity of any of
              its content or programming in any media to materials or ideas
              transmitted to Skript. 12.3. Customer Support. To find more
              information about our service and its features or if you need
              assistance with your account, please visit the Skript Help Center,
              which is accessible through the Skript.com website. In certain
              ...
              these Terms of Use will be controlled. 12.4. Changes to Terms of
              Use and Assignment. Skript may, from time to time, change these
              Terms of Use. We will notify you at least 30 days before such
              changes apply to you. We may assign or transfer our agreement with
              you including our associated rights and obligations at any time
              and you agree to cooperate with us in connection with such an
              assignment or transfer. 12.5. Electronic Communications. We will
              send you information relating to your account (e.g. payment
