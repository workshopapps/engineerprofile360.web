  ...
  return (
    <div className={styles.Assessment_container}>
        ...
        <div className={styles.Filter_wrapper}>
            <button className={styles.Filter_button}>Assessment Type <img src={ArrowSvg} alt='Arrow' width={13}/></button>
            <div className={styles.Filter_flex}>
                <button className={styles.Filter_button}>Sort By Date <img src={ArrowSvg} alt='Arrow' width={13}/></button> 
                <div><img src={FilterSvg} alt='Filter' width={40}/></div>
                <div><img src={MenuSvg} alt='Menu' width={40}/></div>
            </div>
        </div>
        <table>
            <thead>
