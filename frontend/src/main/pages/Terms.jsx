  ...
  return (
    <TermsContainer>
      <Container>
        <PageHeader>
          <PageHead>
            Eval360 <Span> Terms of Service</Span>
          </PageHead>
        ...
        <MainSection>
          <LeftContent>
            ...
            <Section id="registration">
              ...
              <InsideContent>
                ...
                we require. The company will keep its business account
                information updated. Company’s name must not: (a) be false,
                misleading, deceptive, or defamatory; (b) parody a third party
                or include character symbols, excessive punctuation, or
                trademark designations; or (c) infringe any trademark, violate
                any right of publicity, or otherwise violate anyone’s rights. We
                reserve the right to reclaim account names on behalf of any
                business or individual that holds a legal claim in those name.
              </InsideContent>
            </Section>
            ...
            <Section id="billing">
              ...
              <InsideContent>
                ...
                amounts. If payment is not successfully settled, due to
                ...
                Method service provider for details. <br />
                <br />
                3. Updating your Payment Methods. You can update your Payment
                Methods by going to the "Account" page. We may also update your
                Payment Methods using the information provided by the payment
            ...
            <Section id="warranty" className="second">
              ...
              <InsideContent>
                ...
                warranties or consumer protection rights that you may be
                entitled to under the mandatory laws of your country of
                residence.
              </InsideContent>
            </Section>

            <Section id="safety">
              <Title>Safety and Regulations</Title>
              <InsideContent>
                ...
                and not disclosed to a third party. Failure to comply with any
                of the provisions of the terms of use would result in the user
                identification code or passwording being disabled.
              </InsideContent>
            </Section>

            <Section id="personal">
              <Title>Use of Your personal/Company Information</Title>
              <InsideContent>
            ...
            <Section id="viruses">
              ...
              <InsideContent>
                ...
                access our site. You should use your virus protection software.
                You must not misuse our software by knowingly introducing
                viruses, trojans, worms, logic bombs or other material that is
                malicious or technologically harmful. You must not attempt to
                gain unauthorized access to our software, the server on which
                our software is stored or any server, computer or database
            ...
            <Section id="License">
              ...
              <InsideContent>
                ...
                downloaded in any way. No illustrations, photographs, video or
                any audio sequence or graphics. Our status and that of any other
                ...
                breach of the terms of use, a user's right to access the site
                will be ceased immediately and at our option return or destroy
                copies of the materials.
              </InsideContent>
            </Section>

            <Section id="UseofOurTrademarks">
              <Title>Use of Our Trademarks</Title>
              <InsideContent>
            ...
            <Section id="Miscelleneous">
              ...
              <InsideContent>
                ...
                and obligations at any time and you agree to cooperate with us
                in connection with such an assignment or transfer. <br />
                12.5. Electronic Communications. We will send you information
          ...
          <RightContent>
            <TableContent>
              ...
              <Table>
                <LinkItem>
                  <LinkTag href="#registration">
                    Registration and Account
                  </LinkTag>
                </LinkItem>
                <LinkItem>
                  <LinkTag href="#Subscription">Subscription</LinkTag>
                </LinkItem>
                <LinkItem>
                  <LinkTag href="#billing">Billing and Cancellation</LinkTag>
                </LinkItem>
                <LinkItem>
                  <LinkTag href="#passwords">
                    Passwords and Account Access
                  </LinkTag>
                </LinkItem>
                <LinkItem>
                  <LinkTag href="#safety">Warranties and limitations</LinkTag>
                </LinkItem>
                <LinkItem>
                  <LinkTag href="#personal">
                    Use of Personal/Company Info
                  </LinkTag>
                </LinkItem>
                <LinkItem>
                  <LinkTag href="#viruses">Viruses</LinkTag>
                </LinkItem>
              </Table>
              <Link to="/contact">
