      ...
      <div className={styles.cards}>
        <div className={styles.card}>
          ...
          <p>
            ...
            commercial applications that meet societal and consumer needs. As a
            vast industry with numerous aspects and specialisations, many
        ...
        <div className={styles.card2}>
          ...
          <p>
            ...
            But thanks to evaluation tool, engineering teams can be tested to
            assess their abilities and can perform at the top of their game
            using results assessments.
          </p>
        </div>
      </div>
    </div>
